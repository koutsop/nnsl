...
namespace gr.uoc.csd.Alpha.Compilation {
    ...
    public class AlphaQuadParsingManager: AbstractParsingManager {
        ...
        private readonly AbstractQuadManager quads;
        private readonly SymbolTable.SymbolTable symbolTable;
        public AlphaQuadParsingManager (AbstractQuadManager quadManager, SymbolTable.SymbolTable symbolTable) {
            quads = quadManager;
